            ...
            <div class="md:w-1/2 pr-4 pl-4">
              <div class="lg:pl-10 mt-6 md:mt-0">
                <div class="flex flex-col gap-4">
                  <!-- content -->
                  <a href="#!" class="block text-blue-600">Bakery Biscuits</a>
                  <!-- heading -->
                  ...
                  <div class="flex flex-col gap-6">
                    ...
                    <div class="flex flex-wrap justify-start gap-2 items-center">
                      <div class="lg:w-1/3 md:w-2/5 w-full grid">
                        ...
                        <button
                          type="button"
                          class="btn bg-blue-600 text-white border-blue-600 disabled:opacity-50 disabled:pointer-events-none hover:text-white hover:bg-blue-700 hover:border-blue-700 active:bg-blue-700 active:border-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300 justify-center"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
